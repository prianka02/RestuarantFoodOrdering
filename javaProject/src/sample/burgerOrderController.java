...
public class burgerOrderController implements Initializable {
    @FXML
    ...
    @FXML
    private TableView<foodList> burgerOrder;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        burgerOrder.getSelectionModel().setSelectionMode(SelectionMode.MULTIPLE);
        this.list.clear();
        ...
        burgerOrder.setItems(this.list);

    }

    @FXML
    public void OrderAction() throws IOException{
        List<foodList> selectedItems = burgerOrder.getSelectionModel().getSelectedItems();
