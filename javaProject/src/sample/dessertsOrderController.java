...
public class dessertsOrderController implements Initializable {
    @FXML
    ...
    @FXML
    private TableView<foodList> dessertsOrder;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        dessertsOrder.getSelectionModel().setSelectionMode(SelectionMode.MULTIPLE);
        this.list.clear();
        ...
        dessertsOrder.setItems(this.list);

    }

    @FXML
    public void OrderAction() throws IOException {
        List<foodList> selectedItems = dessertsOrder.getSelectionModel().getSelectedItems();
