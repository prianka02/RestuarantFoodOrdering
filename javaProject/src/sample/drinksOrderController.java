...
public class drinksOrderController implements Initializable {
    @FXML
    ...
    @FXML
    private TableView<foodList> drinksOrder;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        drinksOrder.getSelectionModel().setSelectionMode(SelectionMode.MULTIPLE);
        this.list.clear();
        ...
        drinksOrder.setItems(this.list);

    }

    @FXML
    public void OrderAction() throws IOException{
        List<foodList> selectedItems = drinksOrder.getSelectionModel().getSelectedItems();
