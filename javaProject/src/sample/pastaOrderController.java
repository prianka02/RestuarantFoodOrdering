...
public class pastaOrderController implements Initializable {
    @FXML
    ...
    @FXML
    private TableView<foodList>pastaOrder;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        pastaOrder.getSelectionModel().setSelectionMode(SelectionMode.MULTIPLE);
        this.list.clear();
        ...
        pastaOrder.setItems(this.list);

    }

    @FXML
    public void OrderAction() throws IOException{
        List<foodList> selectedItems = pastaOrder.getSelectionModel().getSelectedItems();
