...
public class pizzaOrderController implements Initializable {
    ...
    @FXML
    private TableView<foodList> pizzaOrder;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        pizzaOrder.getSelectionModel().setSelectionMode(SelectionMode.MULTIPLE);
        this.list.clear();
        ...
        pizzaOrder.setItems(this.list);

    }

    @FXML
    public void OrderAction() throws IOException{
        List<foodList> selectedItems = pizzaOrder.getSelectionModel().getSelectedItems();
